...
// set Prefix to avoid data being overwritten
...
app.controller('main', function($scope, $ionicModal, localStorageService) {
  // store the entities in a variable 
  var taskData = 'task';

  // initializes the tasks scope with an empty array
  $scope.tasks = [];

  // initializes the task scope with an empty object
  $scope.task = {};
